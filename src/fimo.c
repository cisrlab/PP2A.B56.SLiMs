...
//int main(int argc, char *argv[]) {
  ...
  //printf("fimo_main: parsed motif input\n");
  ...
  //printf("fimo_main: set up priors input\n");
  ...
  //printf("fimo main: create cisml data\n");
